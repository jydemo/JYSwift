...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func playVideoButtonDidTouch(sender: AnyObject) {
        ...
        let url1 = NSBundle.mainBundle().URLForResource("nonje", withExtension: "mp3")
        ...
        //let url = NSURL(fileURLWithPath: path!)
            ...
            presentViewController(playViewController, animated: true) {
                ...
                let _ = CGRect(x: 0, y: 0, width: 100, height: 100)
                
                let _ = CGSize(width: 100, height: 100)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.videoTtitleLabel.text = video.title
