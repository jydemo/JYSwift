...
class TopicsTableViewController: UITableViewController, XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "https://feeds.feedburner.com/appcoda")
        
        xmlParser = JYXMLParser()
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("JYCell", forIndexPath: indexPath)
